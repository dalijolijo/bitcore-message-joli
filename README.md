...
bitcore-message-joli adds support for verifying and signing jolicoin messages in [Node.js](http://nodejs.org/) and web browsers.
...
var Message = require('bitcore-message-joli');
